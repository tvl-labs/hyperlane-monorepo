...
DOCKER_BUILDKIT=1 docker build $PLATFORM -t public.ecr.aws/j8j5l5q3/khala-hyperlane:$TAG .


DOCKER_BUILDKIT=1 docker build --platform=linux/amd64 -t samueldare/khala-hyperlane-validator .